package com.example.animalquiz.dbQuiz2;
...
public class DBHelper extends SQLiteOpenHelper {
    public static final String NOM_DB = "Quiz2";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        Scanner scn = new Scanner(this.contexto.getResources().openRawResource(R.raw.database2));
